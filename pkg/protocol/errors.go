...
func buildErrorRegistry() map[string]ErrorClassification {
	...
	register(ErrorClassAuthorization, false,
		...
		"internal_auth_not_configured", "internal_batch_requires_token_wrapper", "internal_command_unauthorized", "internal_topic_delete_forbidden", "internal_topic_truncate_forbidden",
	...
	register(ErrorClassValidation, false,
		...
		"missing_broker", "missing_event_id", "missing_leader_fence", "missing_match_id", "missing_member", "missing_message", "missing_offset", "missing_partition", "missing_payload",
	...
	register(ErrorClassInternal, false,
		"aggregate_index_lookup_failed", "aggregate_proof_", "aggregate_proof_unavailable", "aggregate_publish_requires_append_stream", "aggregate_range_", "aggregate_range_incomplete",
		"aggregate_partition_mismatch", "aggregate_replay_not_enabled", "append_stream_failed", "broker_error", "command_failed", "coordinator_error", "create_topic_failed",
