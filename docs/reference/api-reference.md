...
Clients and SDKs should reconnect to that leader and retry. Followers index replicated event-sourcing records and rebuild stream indexes from the committed log after restart.
